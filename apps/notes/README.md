...
- Ignores symlinked files/directories (using `lstat`, never dereferences links) and skips symlinked source roots.
- Prints a sync summary including copied files, publish-filtered files, and symlink-skipped paths.
