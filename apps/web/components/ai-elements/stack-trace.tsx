...
const parseStackFrame = (line: string): StackFrame => {
  ...
  if (withParensMatch) {
    const [, functionName = null, filePath = null, lineNum = null, colNum = null] = withParensMatch;
  ...
  if (withoutFnMatch) {
    const [, filePath = null, lineNum = null, colNum = null] = withoutFnMatch;
    const isInternal =
...
const parseStackTrace = (trace: string): ParsedStackTrace => {
  ...
  if (errorMatch) {
    const [, type = null, msg = ""] = errorMatch;
    errorType = type;
    errorMessage = msg || "";
  }
